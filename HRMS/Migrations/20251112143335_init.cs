    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalaryComponent", x => x.ComponentID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Employees_ApprovedByHRID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PayslipDetailID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_payslipDetails", x => x.PayslipDetailID);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_payslipDetails_SalaryComponent_ComponentID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payslipDetails_ComponentID",
